...
class Settings(BaseSettings):
    ...
    api_key: str = Field(..., validation_alias="POLO_ADAPTER_API_KEY")
    main_base_url: str = Field(..., validation_alias="POLO_ADAPTER_MAIN_BASE_URL")
    sqlite_path: str = Field("data/hancat.db", validation_alias="POLO_ADAPTER_SQLITE_PATH")
    host: str = Field("0.0.0.0", validation_alias="POLO_ADAPTER_HOST")
    port: int = Field(8100, validation_alias="POLO_ADAPTER_PORT")
    task_id_wait_seconds: float = Field(5.0, validation_alias="POLO_ADAPTER_TASK_ID_WAIT_SECONDS")
    image_timeout_seconds: float = Field(15.0, validation_alias="POLO_ADAPTER_IMAGE_TIMEOUT_SECONDS")
    image_max_bytes: int = Field(10 * 1024 * 1024, validation_alias="POLO_ADAPTER_IMAGE_MAX_BYTES")
    image_max_redirects: int = Field(3, validation_alias="POLO_ADAPTER_IMAGE_MAX_REDIRECTS")
